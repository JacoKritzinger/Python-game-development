...
text_surface = game_font.render('YOU WON!',True,(225,225,225))
...
while True:
	...
	screen.blit(cloud1_bg,(250,122))
	screen.blit(cloud2_bg,(800,45))

	screen.blit(cloud1_bg,(960,100))
	screen.blit(cloud2_bg,(600,93))

	screen.blit(cloud1_bg,(1110,50))
